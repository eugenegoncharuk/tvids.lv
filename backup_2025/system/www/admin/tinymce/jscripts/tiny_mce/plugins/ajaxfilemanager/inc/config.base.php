...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define("CONFIG_LOGIN_USERNAME", 'manager');
	define('CONFIG_LOGIN_PASSWORD', 'manager123');
	...
	define('CONFIG_SYS_DEFAULT_PATH', '../../../../../../up/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', '../../../../../../up/');	//accept relative path only
	...
	define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,png,txt,doc,docx,pdf,xls,xlsx'); // 
