...
/*		array (
	...
	$cfg['ilibs'] = array (																// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions	
		array (																		
			'value'   	=> 'system/www/up/images/',												
			'text'    	=> 'Site Pictures',
		),
		array (
			'value'   	=> 'system/www/up/gallery/', 				
			'text'    	=> 'Gallery',
		),	
	);*/
	//-------------------------------------------------------------------------
	...
	$cfg['ilibs_dir'] 	   = array('/system/www/up/');					   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
	...
	$cfg['base_url'] 	= 'https://www.tvids.lv/'; 							// base url; e.g. 'http://localhost/'	
