...
function getFormSend($path, $msg){
	...
	<tr>
	<td><span id="style46">Jūsu jautājums</span><span id="style43"> <font color="#FF0000">*</font></span>
	<br>
	<textarea name="message" rows="8" cols="35" value="" size="5000">'.@$_POST['message'].'</textarea></td>
	</tr>

	<tr>
	<td width="40%"><span id="style46">Vārds</span><span id="style43"> <font color="#FF0000">*</font></span>
	...
	<tr>
	<tr>
	<td><span id="style46">Pasākuma datums</span><span id="style43"> vai sezona <font color="#FF0000">*</font></span>
	<br>
	...
	<tr align="left">
		<td height="45">
			<input type="submit" name="contact_submit" style="margin-left: 140px;" value="Aizsūtīt">
