...
<form name="reg_form" action="<?=base_url()?>{cur_lang}/web/{action}" method="POST">
	...
	<tr>
	 <td align="center">
	   <table cellspacing="0" cellpadding="0" id="regform" border="0">
	   ...
	   <tr>
	    <td width="250">{login} <font color="red">*</font></td>
	    <td>
	     <input name="name" type="text" maxlength="30" value="<?=@$_POST['name']?>">
	    </td>
	   </tr>
	   <tr>
	    <td width="250">{password} <font color="red">*</font></td>
	    <td>
	     <input name="password" type="password" maxlength="10">
	    </td>
	   </tr>
	   <tr>
	    <td width="250">{password_repeat} <font color="red">*</font></td>
	    <td>
	     <input name="password2" type="password" maxlength="10">
	    </td>
	   </tr>
	   ...
	   <tr>
	    <td colspan="2"><font color="red">{oblig_info}</font></td>
	   </tr>
